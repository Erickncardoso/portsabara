    ...
    <>
      ...
      >
        <div className="flex items-center gap-3">
          <div className="h-12 w-12 rounded-full bg-green-500 flex items-center justify-center text-white font-bold border border-gray-200">
            {getInitials(nome)}
          </div>
      ...
      >
        <div className="h-10 w-10 rounded-full bg-green-500 flex items-center justify-center text-white font-bold border border-gray-200">
          {getInitials(nome)}
        </div>
      </div>
