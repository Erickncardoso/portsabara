  ...
  return (
    <Card className="shadow-sm border">
      <CardHeader className="bg-white pb-0">
        <CardTitle className="text-xl font-semibold">Histórico de Manutenções</CardTitle>
      </CardHeader>
                  ...
                  <td className="py-3">
                    <div className="flex items-center gap-2">
                      <Avatar className="h-8 w-8">
                        <AvatarImage src={manutencao.medico.imagem} alt={manutencao.medico.nome} />
                        <AvatarFallback>{manutencao.medico.nome.substring(0, 2)}</AvatarFallback>
                      </Avatar>
                      <div>
                        <p className="font-medium">{manutencao.medico.nome}</p>
                        <p className="text-xs text-gray-500">{manutencao.medico.especialidade}</p>
                      </div>
                    </div>
                  </td>
