...
const HeaderMedico: React.FC<HeaderMedicoProps> = ({ 
  ...
  useEffect(() => {
    ...
    const notificacoesArmazenadas = localStorage.getItem('notificacoesMedico');
    ...
    if (notificacoesArmazenadas) {
      ...
      localStorage.setItem('notificacoesMedico', JSON.stringify(notificacoesIniciais));
    }
  }, []);

  const salvarNotificacoes = (novasNotificacoes: Notificacao[]) => {
    setNotificacoes(novasNotificacoes);
    localStorage.setItem('notificacoesMedico', JSON.stringify(novasNotificacoes));
  };
