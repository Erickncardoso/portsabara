...
import { Calendar, FileText, Activity, Hospital, User, LogOut, Phone, ChevronFirst, ChevronLast } from 'lucide-react';
    ...
    <>
      ...
      <Button
        ...
        className={cn(
          ...
          "lg:left-[240px] lg:top-6", // Posição no desktop
          "left-4 top-4", // Posição no mobile
          isOpen && "lg:left-[240px]", // Ajusta posição quando aberto no desktop
          !isOpen && "lg:left-[60px]" // Ajusta posição quando fechado no desktop
        )}
        onClick={onToggle}
      >
