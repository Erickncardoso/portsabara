...
const Chat: React.FC<ChatProps> = ({ isOpen, onClose, currentUser }) => {
  ...
  const contacts = filterContactsByRole(allContacts, currentUser.role)
            ...
            {filteredContacts.map(contact => (
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className={cn("text-sm", getRoleColor(contact.role))}>{contact.role}</p>
                </div>
              </div>
            ))}
          </ScrollArea>
              ...
              {getContactMessages().map(message => (
                <div
                  ...
                  className={cn(
                    ...
                    message.from === currentUser.id ? "ml-auto items-end" : "items-start"
                  )}
                >
                  <div className={cn(
