...
export const HeaderLimpeza: React.FC<HeaderLimpezaProps> = ({ 
  ...
  useEffect(() => {
    ...
    const notificacoesArmazenadas = localStorage.getItem('notificacoesLimpeza');
    ...
    if (notificacoesArmazenadas) {
      ...
      localStorage.setItem('notificacoesLimpeza', JSON.stringify(notificacoesIniciais));
    }
  }, []);

  const salvarNotificacoes = (novasNotificacoes: Notificacao[]) => {
    setNotificacoes(novasNotificacoes);
    localStorage.setItem('notificacoesLimpeza', JSON.stringify(novasNotificacoes));
  };
