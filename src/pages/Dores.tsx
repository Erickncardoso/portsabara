          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <p className="text-gray-600 max-w-3xl mx-auto">
                O nosso portal oferece soluções inovadoras para minimizar esse
                desconforto, promovendo uma recuperação mais rápida e um
                atendimento mais humanizado, melhorando a experiência do
                paciente e tornando o processo de tratamento mais eficiente e
                confortável.
              </p>
              <a
                href="#solucoes"
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center mb-12">
              ...
              <p className="text-gray-600">
                Para enfrentar cada um desses desafios, desenvolvemos soluções
                específicas integradas ao nosso Portal Interno. Veja como
            ...
            <div className="space-y-12 max-w-3xl mx-auto">
              <div className="bg-white p-6 rounded-lg shadow">
                <h3 className="text-xl font-semibold text-sabara-blue mb-4">
                  Registros e Documentação
                </h3>
                <p className="text-gray-600 mb-4">
                  Implementamos um sistema digital de prontuário eletrônico que
                  permite registro rápido de informações e acesso instantâneo a
                  todo histórico do paciente, eliminando a necessidade de busca
                  manual de documentos.
                </p>
                <p className="text-gray-600">
                  Os médicos e enfermeiros podem acessar e atualizar informações
                  em tempo real, garantindo continuidade no cuidado e economia
                  de tempo.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <p className="text-gray-600 mb-4">
                  Nossa plataforma centraliza toda comunicação entre equipes
                  médicas, administrativas e pacientes, com notificações em
                  tempo real e canais específicos para cada tipo de informação.
                </p>
                <p className="text-gray-600">
                  Os pacientes podem receber atualizações sobre seus
                  tratamentos, enquanto as equipes internas mantêm comunicação
                  fluida e documentada.
                </p>
              </div>
              ...
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <p className="text-gray-600 mb-4">
                  Implementamos um módulo específico para gestão de medicamentos
                  e suprimentos, com controle automatizado de estoque, alertas
                  para reposição e rastreamento completo do uso de medicamentos.
                </p>
                <p className="text-gray-600">
                  O sistema garante que nunca faltem insumos essenciais e
                  otimiza todo o processo logístico da farmácia hospitalar.
                </p>
              </div>
            </div>
          </div>
