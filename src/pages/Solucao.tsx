    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        <Banner
          ...
          descricao="Conheça como o Portal Interno resolve os principais desafios do HospitAll."
        />
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <p className="text-gray-600 max-w-3xl mx-auto">
                O Portal Interno é a resposta para os principais desafios
                enfrentados no dia a dia do hospital. Uma solução única para
                transformar a gestão hospitalar e proporcionar uma experiência
                mais eficiente e humanizada para todos.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-gray-600 mb-6">
                  Nosso portal utiliza tecnologia de ponta para oferecer uma
                  experiência intuitiva e eficiente. Com interface amigável e
                  funcionalidades avançadas, transformamos a forma como o
                  hospital gerencia suas operações diárias.
                </p>
                <p className="text-gray-600 mb-6">
                  A plataforma foi desenvolvida considerando as necessidades
                  específicas de cada área do hospital, garantindo que todos os
                  processos sejam otimizados e integrados.
                </p>
                <ul className="space-y-3">
                  ...
                  <li className="flex items-center">
                    ...
                    <span className="text-gray-700">
                      Gestão automatizada de estoques e medicamentos
                    </span>
                  </li>
                  <li className="flex items-center">
                    <div className="bg-green-100 p-1 rounded-full mr-3">
                    ...
                    <span className="text-gray-700">
                      Comunicação segura entre equipes médicas
                    </span>
                  </li>
                </ul>
              </div>
