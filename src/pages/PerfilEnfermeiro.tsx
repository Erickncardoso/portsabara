...
const PerfilEnfermeiro: React.FC = () => {
  ...
  const currentUser = {
    ...
    role: "Enfermeiro(a)",
    avatar: "/images/avatar-enfermeiro.png",
    dataNascimento: "20/08/1988",
    telefone: "(11) 97777-6666",
    cpf: "345.678.901-22",
    endereco: {
      rua: "Rua dos Enfermeiros",
      numero: "321",
      complemento: "Casa 15",
      bairro: "Vila Saúde",
      cidade: "São Paulo",
    ...
    dadosProfissionais: {
      ...
      experiencia: "8 anos",
      formacao: "Enfermagem - UNIFESP",
      especializacao: "UTI Pediátrica",
      certificacoes: [
                  ...
                  <div className="text-center">
                    ...
                    <div className="flex items-center justify-center gap-2 mt-2">
                      ...
                      <Badge variant="outline">
                        {currentUser.dadosProfissionais.coren}
                      </Badge>
                    </div>
                  </div>
                </div>
                    ...
                    >
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          <Input
                            id="coren"
                            value={currentUser.dadosProfissionais.coren}
                            disabled
                          />
                        </div>
                        <div className="space-y-2">
