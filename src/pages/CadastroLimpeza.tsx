...
const CadastroLimpeza: React.FC = () => {
            ...
            <Card className="shadow-xl border-0 overflow-hidden rounded-3xl">
              <div className="flex flex-col md:flex-row">
                ...
                <div className="w-full md:w-2/5 bg-sabara-blue text-white p-10 flex flex-col justify-center items-center text-center">
                  ...
                  <p className="text-xl mb-6">Preencha os dados para cadastrar um funcionário da limpeza</p>
                </div>
                
                {/* Lado direito com formulário de cadastro */}
                <div className="w-full md:w-3/5 p-10">
                  <div className="mb-10">
                    <h2 className="text-3xl font-bold text-gray-800">Cadastro Limpeza</h2>
                  </div>
...
export default CadastroLimpeza;
