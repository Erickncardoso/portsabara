...
const PerfilMedico: React.FC = () => {
  ...
  const currentUser = {
    ...
    dadosProfissionais: {
      ...
      residencia: "Cardiologia - Hospital das Clínicas",
      certificacoes: ["Cardiologia", "Ecocardiografia", "Medicina Intensiva"],
    },
  };
                  ...
                  <div className="text-center">
                    ...
                    <div className="flex items-center justify-center gap-2 mt-2">
                      ...
                      <Badge variant="outline">
                        CRM {currentUser.dadosProfissionais.crm}
                      </Badge>
                    </div>
                  </div>
                </div>
                    ...
                    >
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          <Input
                            id="crm"
                            value={currentUser.dadosProfissionais.crm}
                            disabled
                          />
                        </div>
                        <div className="space-y-2">
                        ...
                        <div className="space-y-2 md:col-span-2">
                          ...
                          <Input
                            id="residencia"
                            value={currentUser.dadosProfissionais.residencia}
                          />
                        </div>
                        <div className="space-y-2 md:col-span-2">
