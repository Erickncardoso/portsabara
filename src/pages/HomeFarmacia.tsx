          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-xl p-6 text-white">
              ...
              <p className="text-blue-100">
                Gerencie medicamentos, receitas e atenda pacientes com
                eficiência.
              </p>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <div
                        className={`p-3 rounded-lg ${getCorClasse(stat.cor)}`}
                      >
                        <Icon size={24} />
                      </div>
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                ...
                <div className="space-y-3">
                      ...
                      >
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            Estoque: {medicamento.estoque} | Mínimo:{" "}
                  ...
                  {medicamentos.filter((m) => m.estoque <= m.estoqueMinimo)
                    .length === 0 && (
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                ...
                <div className="space-y-3">
                  ...
                  {receitas.filter((r) => r.status === "Pendente").length ===
                    0 && (
                    <p className="text-gray-500 text-center py-4">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <button
                  onClick={() =>
                    (window.location.href = "/medicamentos-farmacia")
                  }
