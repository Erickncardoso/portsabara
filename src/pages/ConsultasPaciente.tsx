            ...
            <Card className="lg:col-span-1 w-full bg-white shadow-sm">
              ...
              <CardContent className="flex justify-center pt-4">
                <Calendar
                  ...
                  onSelect={setDate}
                  locale={ptBR}
                  className={cn("rounded-md w-full", "mx-auto")}
                  classNames={{
                    months: "flex flex-col space-y-4",
                    month: "space-y-2 w-full",
                    caption:
                      "flex justify-center pt-1 relative items-center px-8 text-sm",
                      ...
                      >
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                          ...
                          <div className="flex flex-col md:items-end gap-2">
                            <Badge
                              variant="outline"
                              className="bg-green-50 text-green-700 border-green-200 px-2"
                            >
                              {consulta.status}
                            </Badge>
                            <Button
